...
git clone https://github.com/sandraschi/nuki-mcp
cd nuki-mcp
just
```
...
4. Start the server:
   ...
   uv run uvicorn nuki_mcp.server:app --port 10980
   ```
5. Open `http://localhost:10980` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/nuki-mcp/issues) |
